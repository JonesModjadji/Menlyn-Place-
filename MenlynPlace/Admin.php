...
$sql = "INSERT INTO rooms (Price, UnitNumber,RoomDetails,DatePosted,Status,RoomImg1,RoomImg2,RoomImg3)
 VALUES ('$Price','$Unit','$RoomDetails','$DatePosted','$Status','$RoomImg1','$RoomImg2','$RoomImg3')";
...
<label style="font-size:30px;"><a href="#" style="text-decoration:none; color:black;">Add Room</a> | 
...
<tr>
<td><textarea placeholder="Room Destails/Description" name="RoomDetails"></textarea></td>
</tr>
<tr>
